...
OldVersion = 'CarMaker 13.*';
NewVersion = 'CarMaker 14.*';
...
for iFile=1:numel(FileList)
    ...
    try
	    ...
	    %%%%% Add update scripts for the models HERE %%%%%
            ...
            update_CarAndTrailer_Kinematics
            update_SuspensionForces_ReplaceSFuncs
            update_SuspensionExtForces_ReplaceOutputs(src_mdl, trg_mdl)
            update_SuspensionForces_SuspExtFrcsUpdate
            update_CarAndTrailer_Kinetics
            update_CarAndTrailer_Forces_CleanUp(src_mdl, trg_mdl)
