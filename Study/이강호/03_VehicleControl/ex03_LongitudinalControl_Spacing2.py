...
class PID_Controller_ConstantTimeGap(object):
    def __init__(self, step_time, target_x, ego_x, ego_vx, timegap = 0.2, P_Gain=5.0, D_Gain=12.0, I_Gain=0.002):
        # Code
    ...
    def ControllerInput(self, target_x, ego_x, ego_vx):
        ...
        self.current_space = target_x - ego_x
        self.error = self.current_space - self.space
