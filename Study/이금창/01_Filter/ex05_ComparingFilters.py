...
if __name__ == "__main__":
    ...
    y_estimate_MAF = MovingAverageFilter(signal.y_measure[0],num_average=5)  # 필요 시 window_size 조정
    y_estimate_LPF = LowPassFilter(signal.y_measure[0],alpha=0.1)  # alpha는 필터 응답 속도 조절
    y_estimate_KF = KalmanFilter(signal.y_measure[0])  # 초기 측정값으로 초기화
