...
static const char *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 13.1 2024-05-06",
    "libcarmaker.a	CarMaker win64 13.1 2024-05-06",
    "libipgdriver.a	IPGDriver win64 13.1 2024-05-02",
    "libipgroad.a	IPGRoad win64 13.1 2024-05-02",
...
static const char *CompileFlags[] = {
    "-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=130100",
...
tAppStartInfo   AppStartInfo = {
    "CarMaker 13.1 - Car_Generic",          /* App_Version         */
    "4",          /* App_BuildVersion    */
    "jetbrains",     /* App_CompileUser     */
    "fef55bd67061",         /* App_CompileSystem   */
    "2024-05-06 14:02:25",  /* App_CompileTime */
